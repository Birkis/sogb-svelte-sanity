...
<!-- NEW DESIGN -->
  <li class="bg-white/5 rounded-2xl overflow-hidden">
    <img class="aspect-[4/5] w-full rounded-2xl object-cover object-top" src={employee.profilePicture ? urlFor(employee.profilePicture).width(400).height(400).url() : 'default_profile.jpg'} alt={fullName}>    <div class="p-6">
